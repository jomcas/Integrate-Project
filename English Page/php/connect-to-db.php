...
$sql = "INSERT INTO english_table (Lesson_Name,Score,Passing_Score,No_Items,Status)
...
if($status = "passed") {
    $update = "UPDATE progress SET done = done + 1 WHERE user_id = '$user_id' and subject = 'ENGLISH'";
